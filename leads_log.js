/**
 * leads_log.js
 * JSON database for tracking all land leads and deals.
 */
...
export function loadLog() {
  if (!fs.existsSync(LOG_FILE)) return { leads: [], stats: { total: 0, smsSent: 0, replied: 0, underContract: 0, assigned: 0 } };
